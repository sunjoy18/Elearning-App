        ...
        <>
            ...
            <div className="col-lg-10 col-md-9 col-sm-8 p-3 bg-white border">
                <div className='m-2'>
                    ...
                    <div className='form '>
                        <form action={`http://${api}/api/update/chapter`} method='post' encType='multipart/form-data' onSubmit={validateOptions}>
                            ...
                            <div className='mb-3'>
                                <label htmlFor='chapterName' className='form-label'>
                                    <b>Add  New Chapter Name:</b>
                                </label>
                                <input type='text' id='chapterName' name='chapterName' className='form-control' placeholder='Enter New Chapter Name' />
                            </div>
